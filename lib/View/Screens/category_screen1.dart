  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Categories', style: GoogleFonts.lato(color: Colors.black, fontWeight: FontWeight.bold),
        ),
      ),
      backgroundColor:  Colors.blue.shade100,
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Center(
                child: Text(category[index], style: TextStyle(color: Colors.green.shade900, fontSize: 20,
                  ),
                ),
              ),
            ),
