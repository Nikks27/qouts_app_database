...
import '../../controller/qouts_controller.dart';
import '../../controller/theme_controller.dart';
import '../smart_widgets/Tab_bar.dart';
import '../smart_widgets/like.dart';
import 'category_screen1.dart';
                        ...
                        child:  Obx(() {
                          ...
                          return
                            CarouselSlider.builder(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          icon: Icon(CupertinoIcons.share, color: Colors.white, size: 30,
                                          ),
                                        ),
                                        SizedBox(
                                          width: 30,
                                        ...
                                        IconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              Get.snackbar(backgroundColor: Colors.yellow.shade100, 'Copied', 'Quote copied to clipboard', snackPosition: SnackPosition.BOTTOM,
                                              );}),
                                      ],
                                    ),
                                  ],
                              ...
                              options: CarouselOptions(scrollDirection: Axis.vertical, pageSnapping: true, initialPage: 0, enlargeCenterPage: true,
                              ),
                            );
                        })
                    )
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(CupertinoIcons.rectangle_grid_2x2_fill, color: Colors.white,
                                  ),
                                  SizedBox(
                                    width: 10,
                                  ),
