  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('$category', style: GoogleFonts.lato(color: Colors.black, fontWeight: FontWeight.bold),
        ),
      ),
      backgroundColor: Colors.blue.shade100,
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(filteredQuotes[index].text, style: TextStyle(color: Colors.green.shade900, fontSize: 25),
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          IconButton(
                            ...
                            icon: Icon(CupertinoIcons.share, color: Colors.green.shade900, size: 30,
                            ),
                          ),
                          SizedBox(
                            width: 30,
